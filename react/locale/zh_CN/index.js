...
const pageDetail = {
  ...
  'c7n.saga.detail.title': '查看事务定义"{name}"的详情',
  'c7n.saga.detail.description': '您可以在此查看事务定义图、事务定义Json。',
  'c7n.saga.detail.link': `${docServer}/user-guide/microservice-development/global-transaction/saga/`,
...
const zh_CN = {
  ...
  // 任务明细
  'c7n.taskdetail.header.title': '任务明细',
  'c7n.taskdetail.create': '创建任务',
  'c7n.taskdetail.last.execution.time': '上次执行时间',
  'c7n.taskdetail.next.execution.time': '下次执行时间',
  'c7n.taskdetail.create.header.title': '创建任务',
  'c7n.taskdetail.task.name': '任务名称',
  'c7n.taskdetail.task.name.required': '请输入任务名称',
  'c7n.taskdetail.task.name.exist': '任务名称已存在，请输入其他任务名称',
  'c7n.taskdetail.task.description': '任务描述',
  'c7n.taskdetail.task.description.required': '请输入任务描述',
  'c7n.taskdetail.task.start.time': '开始时间',
  'c7n.taskdetail.task.start.time.required': '请输入开始时间',
  'c7n.taskdetail.task.range.required': '请输入开始时间和结束时间',
  'c7n.taskdetail.task.end.time': '结束时间',
  'c7n.taskdetail.task.end.time.required': '请输入结束时间',
  'c7n.taskdetail.trigger.type': '触发类型',
  'c7n.taskdetail.easy.task': '简单任务',
  'c7n.taskdetail.cron.task': 'Cron任务',
  'c7n.taskdetail.cron.expression': 'Cron表达式',
  'c7n.taskdetail.cron.expression.required': '请输入Cron表达式',
  'c7n.taskdetail.cron.tip': '请填写Cron表达式',
  'c7n.taskdetail.cron.tip.link': `${docServer}/user-guide/microservice-development/job/cron-expression/`,
  'c7n.taskdetail.cron.example': '示例',
  'c7n.taskdetail.cron.runtime': '第{time}次执行时间:',
  'c7n.taskdetail.cron.wrong': 'Cron表达式错误，请重新输入。',
  'error.cron.parse': 'Cron表达式错误，请重新输入。',
  'c7n.taskdetail.service.required': '请选择服务名',
  'c7n.taskdetail.task.class.required': '请选择任务程序',
  'c7n.taskdetail.service.name': '服务名',
  'c7n.taskdetail.task.class.name': '任务程序',
  'c7n.taskdetail.params.name': '参数名称',
  'c7n.taskdetail.params.value': '参数值',
  'c7n.taskdetail.params.type': '参数类型',
  'c7n.taskdetail.params.description': '参数描述',
  'c7n.taskdetail.params.data': '参数数据',
  'c7n.taskdetail.unit': '间隔单位',
  'c7n.taskdetail.repeat.interval': '重复间隔',
  'c7n.taskdetail.repeat.required': '请输入重复间隔',
  'c7n.taskdetail.repeat.pattern': '请输入正整数',
  'c7n.taskdetail.repeat.time': '执行次数',
  'c7n.taskdetail.repeat.time.required': '请输入执行次数',
  'c7n.taskdetail.detail.header.title': '任务详情',
  'c7n.taskdetail.task.info': '任务信息',
  'c7n.taskdetail.task.log': '任务日志',
  'c7n.taskdetail.task.status': '状态',
  'c7n.taskdetail.instance.id': '实例ID',
  'c7n.taskdetail.plan.execution.time': '计划执行时间',
  'c7n.taskdetail.actual.execution.time': '实际执行时间',
  'c7n.taskdetail.delete.title': '删除任务',
  'c7n.taskdetail.delete.content': '确定要删除任务"{name}"吗？',
  'c7n.taskdetail.noprogram': '无可选任务程序时，无法创建任务',
  'c7n.taskdetail.num.required': '请输入数字',
  'c7n.taskdetail.default.required': '无默认值时必填',
  'c7n.taskdetail.step1.title': '任务信息',
  'c7n.taskdetail.step2.title': '配置触发条件',
  'c7n.taskdetail.step3.title': '设置通知对象',
  'c7n.taskdetail.step4.title': '确认信息',
  'c7n.taskdetail.step1.description': '填写任务的名称及描述说明，为任务配置触发条件。您可以选择简单任务或者Cron任务。了解如何填写cron表达式。',
  'c7n.taskdetail.step2.description': '您可以在此配置任务要执行的程序。',
  'c7n.taskdetail.step3.description': '在这里你可以选择任务状态发生变化的通知对象。在任务状态发生变化或者出故障时可以及时通知到相关用户。',
  'c7n.taskdetail.step.next': '下一步',
  'c7n.taskdetail.step.prev': '上一步',
  'c7n.taskdetail.add.specified.user': '添加指定用户',
  'c7n.taskdetail.login.name': '登录名',
  'c7n.taskdetail.real.name': '用户名',
  'c7n.taskdetail.seconds': '秒',
  'c7n.taskdetail.minutes': '分',
  'c7n.taskdetail.hours': '时',
  'c7n.taskdetail.days': '天',
  'c7n.taskdetail.noservice': '无服务',
  'c7n.taskdetail.noprograms': '无任务程序',
  'c7n.taskdetail.creator': '创建者',
  'c7n.taskdetail.manager': '管理员',
  'c7n.taskdetail.user': '指定用户',
  'c7n.taskdetail.site': '平台',
  'c7n.taskdetail.organization': '组织',
  'c7n.taskdetail.project': '项目',
  'c7n.taskdetail.inform.person': '通知对象',
  'c7n.taskdetail.nousers': '暂无指定用户',
  'c7n.taskdetail.simple.trigger': '简单任务',
  'c7n.taskdetail.cron.trigger': 'Cron任务',
  'c7n.taskdetail.empty': '无',
  'c7n.taskdetail.number.pattern': '请输入数字',
  'c7n.taskdetail.execute-strategy': '超时策略',
  'c7n.taskdetail.execute-strategy.tips': '超时策略：\n'
    + '阻塞： 下次触发时间若上次触发任务未完成，则暂停定时任务，任务不再被执行\n'
    + '串行： 下次触发时间若上次触发任务未完成，两次任务可按照触发时间依次被执行\n'
    + '并行： 下次触发时间若上次触发任务未完成，两次任务可以同时被执行',
  'c7n.taskdetail.execute-strategy.required': '请选择超时策略',
  'c7n.taskdetail.stop': '阻塞',
  'c7n.taskdetail.serial': '串行',
  'c7n.taskdetail.parallel': '并行',
  ...
  // 事务定义
  'c7n.saga.header.title': '事务定义',
  'c7n.saga.detail': '事务定义详情',
  'c7n.saga.img': '图',
  'c7n.saga.json': 'Json',
  'c7n.saga.task.run.title': '任务运行情况',
  'c7n.saga.task.code': '任务编码',
  'c7n.saga.task.run.status': '状态',
  'c7n.saga.task.seq': '序列',
  'c7n.saga.task.run.service-instance': '运行的微服务实例',
  'c7n.saga.task.max-retry': '最大重试次数',
  'c7n.saga.task.run.retried': '已重试次数',
  'c7n.saga.task.run.exception.msg': '异常信息',
  'c7n.saga.task.run.result.msg': '运行结果',
  'c7n.saga.task.detail.title': '任务详情',
  'c7n.saga.task.desc': '任务描述',
  'c7n.saga.task.timeout.time': '超时时间',
  'c7n.saga.task.timeout.policy': '超时策略',
  'c7n.saga.task.service': '所属微服务',
  'c7n.saga.task.input.title': '输入数据',
  'c7n.saga.task.input.demo': '输入数据示例',
  'c7n.saga.task.output.title': '输出数据',
  'c7n.saga.task.unlock': '解锁',
  'c7n.saga.task.retry': '重试',
  'c7n.saga.task.retry.success': '重试成功',
  'c7n.saga.task.unlock.success': '解锁成功',
  'c7n.saga.json.nodata': '暂无数据',
  'c7n.saga.task.concurrentlimit.policy': '并发限制模式',
  'c7n.saga.task.concurrentlimit.num': '最大并发数',
  'c7n.saga.task.plannedstarttime': '计划执行时间',
  'c7n.saga.task.actualstarttime': '实际开始时间',
  'c7n.saga.task.actualendtime': '实际完成时间',
  'c7n.saga.task.abort': '强制失败',
