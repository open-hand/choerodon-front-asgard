...
To install the chart with the release name `choerodon-front-asgard`:

```console
$ helm repo add c7n https://openchart.choerodon.com.cn/choerodon/c7n
$ helm repo update
$ helm install choerodon-front-asgard c7n/choerodon-front-asgard
```
...
```bash
$ helm delete choerodon-front-asgard
```
...
| asgard.pullPolicy | string | `"IfNotPresent"` | Specify a imagePullPolicy # Defaults to 'Always' if image tag is 'latest', else set to 'IfNotPresent' # ref: http://kubernetes.io/docs/user-guide/images/#pre-pulling-images # |
| asgard.pullSecrets | list | `[]` | Optionally specify an array of imagePullSecrets. # Secrets must be manually created in the namespace. # ref: https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/ # e.g: # pullSecrets: #   - myRegistryKeySecretName # |
| asgard.registry | string | `"registry.cn-shanghai.aliyuncs.com"` | Java asgard image registry |
| asgard.repository | string | `"c7n/frontasgard"` | Java asgard image repository |
| asgard.tag | string | `"0.10.0"` | Java asgard image tag |
